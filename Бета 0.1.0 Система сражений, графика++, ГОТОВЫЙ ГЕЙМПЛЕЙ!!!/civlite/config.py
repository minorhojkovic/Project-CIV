...
UNITS["worker"]["dice"] = None
UNITS["worker"]["min_range"] = 1

UNITS["scout"]["dice"] = None
UNITS["scout"]["min_range"] = 1

UNITS["infantry"]["dice"] = 2
UNITS["infantry"]["min_range"] = 1

UNITS["heavy_infantry"]["dice"] = 6
UNITS["heavy_infantry"]["min_range"] = 1

UNITS["knight"]["dice"] = 2
UNITS["knight"]["min_range"] = 1

UNITS["heavy_knight"]["dice"] = 4
UNITS["heavy_knight"]["min_range"] = 1

UNITS["archer"]["dice"] = 2
UNITS["archer"]["min_range"] = 2

UNITS["longbowman"]["dice"] = 2
UNITS["longbowman"]["min_range"] = 2
